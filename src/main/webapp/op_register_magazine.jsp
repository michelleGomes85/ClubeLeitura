			...
			<form action="${pageContext.request.contextPath}/controller"
				...
				<c:choose>
					...
					<c:when test="${empty caixas}">
						<p class="error-message">Não é possível realizar o cadastro,
							pois não há caixas disponíveis</p>
					</c:when>
					...
					<c:otherwise>
						...
						<div class="form-group">
							<label for="colecao">Coleção:</label> <input type="text"
								id="colecao" name="colecao"
								placeholder="Digite a coleção da revista" required>
						</div>

						<div class="form-group">
							<label for="num-edicao">Número da Edição:</label> <input
								type="number" id="num-edicao" name="num-edicao"
								placeholder="Digite o número da edição" required>
						</div>

						<div class="form-group">
							<label for="ano-revista">Ano da Revista:</label> <input
								type="number" id="ano-revista" name="ano-revista"
								placeholder="Digite o ano da revista" required>
						</div>

						<div class="form-group">
							<label for="idcaixa">Caixa:</label> <select id="idcaixa"
								name="idcaixa" required>
						...
						<button type="submit" class="btn-submit">Cadastrar
							Revista</button>

						<input type="text" hidden="true" name="service"
							value="RegisterMagazine">
					</c:otherwise>
				</c:choose>
			</form>
